...
static constexpr auto qt_meta_stringdata_CLASSSingletonClientENDCLASS = QtMocHelpers::stringData(
    "SingletonClient",
    "auth_ok",
    "",
    "auth_fail",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSingletonClientENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSingletonClientENDCLASS_t qt_meta_stringdata_CLASSSingletonClientENDCLASS = {
    {
