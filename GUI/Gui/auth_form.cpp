    ...
    ui(new Ui::Auth_form)
{
    ...
    connect(SingletonClient::getInstance(), &SingletonClient::auth_fail,this,&Auth_form::slot_fail);
}
...
void Auth_form::slot_fail(QString log)
{
    ui->fails->setText("Неверный логин или пароль");
}
